...
<head>
     ...
     <title>Local Payment Response</title>
<!-- 
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <form id="contact-form" role="form" action="PlayerEntryI.jsp" method="post">
                              <div class="section-title">
                                   <h2>Local Payment Response <small></small></h2>
                              </div>

                              <div class="col-sm-12">
                              		 <div class="row"  style="font-size: 15px;padding: 10px;background-color:Gray;color:White;">
										  <div class="col-sm-2">CustomerId</div>
										  <div class="col-sm-2">S.A.No.</div>
										  <div class="col-sm-2">T.A.No.</div>
										  <div class="col-sm-2">AmonutCCY</div>
										  
										  
										  <div class="col-sm-2">Trans.Ref.No.</div>
										  <div class="col-sm-2">PaymentStatus</div>
										</div> 
									...
									String sql="Select * from localpaymentrequest ";
									resultSet = st.executeQuery(sql);
										while (resultSet.next()) {
											
										%>
										<div class="row"  style="font-size: 15px;padding: 5px;color:White;">
										<div class="col-sm-2"><%=resultSet.getString("Id")%></div>
										<div class="col-sm-2"><%=resultSet.getString("SourceAccountNumber")%></div>
										<div class="col-sm-2"><%=resultSet.getString("TargetAccountNumber")%></div>
										<div class="col-sm-2"><%=resultSet.getString("AmonutCCY")%></div>
										
										<div class="col-sm-2"><%=resultSet.getString("PaymentStatus")%></div>
										</div>
										<hr>
										<%
										}
