                    ...
                    <div class="col-md-12 col-sm-12">
                         <form id="contact-form" role="form" action="PlayerEntryI.jsp" method="post">
                              <div class="section-title">
                                   <h2>Cross Payment Response <small></small></h2>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                              		 <div class="row"  style="font-size: 15px;padding: 10px;background-color:Gray;color:White;">
										  ...
										  <div class="col-sm-2">At.T.CCY</div>

										  <div class="col-sm-3">PaymentStatus</div>
									...
									resultSet = st.executeQuery(sql);
										...
										<div class="col-sm-2"><%=resultSet.getString("AmonutTargetCCY")%></div>

										<div class="col-sm-3"><%=resultSet.getString("PaymentStatus")%></div>
										</div>
										<hr>
										<%
										}
