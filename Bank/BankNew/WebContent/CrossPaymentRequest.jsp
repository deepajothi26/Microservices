...
String AmonutTargetCCY=request.getParameter("AmonutTargetCCY");
...
int i=st.executeUpdate("insert into CrossPaymentRequest(CustomerId,SourceAccountNumber,TargetAccountNumber,AmonutCCY,AmonutTargetCCY,BaseCurrency)values('"+ 
		CustomerId +"','"+ SourceAccountNumber +"','"+ TargetAccountNumber +"','"+ AmonutCCY +"','"+ AmonutTargetCCY +"','"+ BaseCurrency +"')");
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="CrossPaymentRequest.jsp" method="post">
                              <div class="section-title">
                                   <h2>Cross Payment Request <small></small></h2>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                   ...
                                   <input type="text" class="form-control" placeholder="Enter Amonut CCY (Target Currency)" name="AmonutTargetCCY" required="">
